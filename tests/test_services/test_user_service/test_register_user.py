...
from app.models.schemas.register import RegisterIn, RegisterInDB


@pytest.fixture
def sample_user_info():
    return RegisterIn(email="test@example.com", password="password123")


async def test_register_user_success(user_service, mock_repo, sample_user_info, sample_user):
    ...
    assert isinstance(called_with, RegisterInDB)
